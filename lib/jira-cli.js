(function() {
  ...
  JiraHelper = (function() {
    ...
    JiraHelper.prototype.getIssue = function(issueNum) {
      var _this = this;
      return this.jira.findIssue(issueNum, function(error, response) {
        if (response != null) {
          _this.response = response;
          return _this.pp.prettyPrintIssue(response);
        } else {
          if (error != null) {
            _this.error = error;
          }
    ...
    JiraHelper.prototype.getMyIssues = function(open) {
      var _this = this;
      return this.jira.getUsersIssues(this.config.user, open, function(error, issueList) {
        ...
        if (issueList != null) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            issue = _ref[_i];
            _results.push(_this.pp.prettyPrintIssue(issue));
          }
          return _results;
        } else {
          if (error != null) {
