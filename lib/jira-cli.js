...
(function() {
  ...
  JiraCli = (function() {
    ...
    JiraCli.prototype.addIssue = function(summary, description, issueType, project) {
      var newIssue,
        _this = this;
      newIssue = {
        fields: {
    ...
    if (args.l) {
      ...
      jiraCli.listTransitions(args.t, function(transitions) {
        ...
        return ask("Transtion Type ", allowedTypes, function(type) {
          return ask("Comment for worklog (blank to skip)", /.*/, function(comment) {
            if (comment.length === 0) {
      ...
      projects = jiraCli.getMyProjects(function(projects) {
        ...
        return ask("Project (" + configFile.project + ")", /.*/, function(project) {
          if (project.length === 0) {
            project = configFile.project;
          }
          return ask("Summary", /.+/, function(summary) {
            return ask("Description", /.+/, function(description) {
              return jiraCli.getIssueTypes(function(issueTypes) {
                var allowedTypes, type, _j, _len1;
                ...
                allowedTypes = (function() {
                  ...
                  _results = [];
                  for (_k = 0, _len2 = issueTypes.length; _k < _len2; _k++) {
                    type = issueTypes[_k];
