...
(function() {
  var JiraApi, JiraCli, args, argv, ask, color, configFile, fs, jiraCli, path, projects, util,
    _this = this;
  ...
  if (require.main === module) {
    argv = (require('optimist')).options('f', {
      ...
      "default": false
    }).usage('Usage: jira -f EG-143 -- jira -r EG-143').boolean('h').boolean('l').string('f').string('r');
    if (argv.argv.help) {
      argv.showHelp();
      return;
    }
